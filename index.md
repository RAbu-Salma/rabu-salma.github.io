Ruba Abu-Salma is a Lecturer (Assistant Professor) in Computer Science at King’s College London (KCL), affiliated with the Cybersecurity Group. Ruba’s research spans computer security, privacy, and human-computer interaction (HCI). She is interested in understanding and developing better tools to improve people’s security- and privacy-related decision-making processes. Her work has been published at top-tier security and privacy venues and has been covered by the popular press, such as The New York Times, The Register, and CNET.

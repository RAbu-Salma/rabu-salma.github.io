Ruba Abu-Salma is a Lecturer (Assistant Professor) in Computer Science at King’s College London (KCL), affiliated with the Cybersecurity Group. Ruba’s research spans computer security, privacy, and human-computer interaction (HCI). She is interested in understanding and developing better methods to improve people’s security- and privacy-related decision-making processes. Her work has been published in top-tier security and privacy venues and has been covered by the popular press, such as The New York Times, The Register, and CNET.
...
Ruba received her Ph.D. in Computer Science from University College London (UCL) in 2019. Her dissertation focused on designing user-centered privacy-enhancing technologies. As a postgraduate student, she was supported by Google, a Marie-Skłodowska Curie Research Fellowship, and a Supporting Usability and Design in Security (SUDS) Fellowship from the Open Technology Fund. She also performed research at Brave and Telefónica Research.
...
1.	SOUPS/Speed Mentoring Program: 2021. (Junior Mentoring Co-Chair)
